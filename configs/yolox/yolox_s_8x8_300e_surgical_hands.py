...
train_dataset = dict(
    ...
    dataset=dict(
        type=dataset_type,
        ann_file=f'{data_root}/coco/fixed/surgical_hands_coco_train.json',
...
data = dict(
    ...
    val=dict(
        type=dataset_type,
        ann_file=f'{data_root}/coco/fixed/surgical_hands_coco_val.json',
        img_prefix=f'{data_root}/images/',
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        ann_file=f'{data_root}/coco/fixed/surgical_hands_coco_test.json',
        img_prefix=f'{data_root}/images/',
        pipeline=test_pipeline))
