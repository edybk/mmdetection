...
train_dataset = dict(
    ...
    dataset=dict(
        type=dataset_type,
        ann_file=f'{data_root}/detection_annotations/apas_train.json',
...
data = dict(
    ...
    val=dict(
        type=dataset_type,
        ann_file=f'{data_root}/detection_annotations/apas_val.json',
        img_prefix=f'{data_root}/',
        pipeline=test_pipeline),
    test=dict(
        type=dataset_type,
        ann_file=f'{data_root}/detection_annotations/apas_test.json',
        img_prefix=f'{data_root}/',
        pipeline=test_pipeline))
